...
CapyHome Frontend is a Next.js 16 web interface for an AI agent system. It communicates with a LangGraph-based backend to provide thread-based AI conversations with streaming responses, artifacts, and a skills/tools system.
...
- **Polling strategy** prefers workspace refresh events plus adaptive intervals (faster while active, slower while idle/background) instead of fixed high-frequency polling
