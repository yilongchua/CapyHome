      ...
      {!isLoading && (
        ...
        >
          <div className="flex gap-1">
            {branchControl && (
              <div className="bg-background/90 text-muted-foreground inline-flex items-center rounded-md border px-1 text-xs">
                <button
                  type="button"
                  className="hover:bg-muted rounded p-1"
                  onClick={branchControl.onPrevious}
                  aria-label="Previous branch"
                >
                  <ChevronLeftIcon className="size-3.5" />
                </button>
                <span className="px-1 text-[11px]">
                  {branchControl.currentIndex + 1}/{branchControl.total}
                </span>
                <button
                  type="button"
                  className="hover:bg-muted rounded p-1"
                  onClick={branchControl.onNext}
            ...
            {isHuman && canEditFork && onEditFork && (
              <button
                type="button"
                className="bg-background/90 hover:bg-muted inline-flex items-center gap-1 rounded-md border px-2 text-xs"
                onClick={onEditFork}
