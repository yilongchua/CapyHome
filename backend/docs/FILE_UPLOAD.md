  ...
  "files": [
    {
      ...
      "size": 1234567,
      "path": ".capyhome/threads/{thread_id}/user-data/workspace/uploads/document.pdf",
      ...
      "markdown_path": ".capyhome/threads/{thread_id}/user-data/workspace/uploads/document.md",
...
- 实际存储：`backend/.capyhome/threads/{thread_id}/user-data/workspace/uploads/document.pdf`
- 前端访问：`/api/threads/{thread_id}/artifacts/mnt/user-data/workspace/uploads/document.pdf`（HTTP URL）

上传流程采用“线程目录优先”策略：
- 先写入 `backend/.capyhome/threads/{thread_id}/user-data/workspace/uploads/` 作为权威存储
...
2. 检查 thread_id 是否正确
3. 确认文件确实已上传到 `backend/.capyhome/threads/{thread_id}/user-data/workspace/uploads/`
