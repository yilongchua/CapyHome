  ...
  "files": [
    {
      ...
      "size": 1234567,
      "path": ".capyhome/threads/abc123/user-data/workspace/uploads/document.pdf",
      "virtual_path": "/mnt/user-data/workspace/uploads/document.pdf",
      "artifact_url": "/api/threads/abc123/artifacts/mnt/user-data/workspace/uploads/document.pdf",
      "markdown_file": "document.md",
      "markdown_path": ".capyhome/threads/abc123/user-data/workspace/uploads/document.md",
      "markdown_virtual_path": "/mnt/user-data/workspace/uploads/document.md",
      "markdown_artifact_url": "/api/threads/abc123/artifacts/mnt/user-data/workspace/uploads/document.md"
    }
  ],
...
- `/api/threads/abc123/artifacts/mnt/user-data/workspace/uploads/document.pdf`
...
You can enable lightweight protection for Gateway endpoints (`/api/*`) by setting:

- `CAPYBARA_API_KEY`
- `CAPYBARA_API_KEY_HEADER` (optional, default: `x-api-key`)

When enabled, each Gateway request must provide either:

- `x-api-key: <your-key>` (or your custom header), or
- `Authorization: Bearer <your-key>`

`/health`, `/docs`, and other non-`/api/*` routes are not gated by this middleware.
