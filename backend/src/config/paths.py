...
class Paths:
    ...
    def host_base_dir(self) -> Path:
        ...
        Set CAPYBARA_HOME_HOST_BASE_DIR to the host-side path that corresponds to this
        ...
        """
        if env := os.getenv("CAPYBARA_HOME_HOST_BASE_DIR"):
            return Path(env)
    ...
    def base_dir(self) -> Path:
        ...
        if env_home := os.getenv("CAPYBARA_HOME"):
