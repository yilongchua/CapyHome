...
class AioSandboxProvider(SandboxProvider):
    ...
    def _get_thread_mounts(thread_id: str) -> list[tuple[str, str, bool]]:
        ...
        # host_paths resolves to the host-side base dir when CAPYBARA_HOME_HOST_BASE_DIR
    ...
    def _get_skills_mount() -> tuple[str, str, bool] | None:
        ...
        Mount source uses CAPYBARA_HOME_HOST_SKILLS_PATH when running inside Docker (DooD)
        ...
        try:
            ...
            if skills_path.exists():
                ...
                host_skills = os.environ.get("CAPYBARA_HOME_HOST_SKILLS_PATH") or str(skills_path)
