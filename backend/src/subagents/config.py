...
class SubagentConfig(CapyBaseModel):
    ...
    Attributes:
        ...
        max_turns: Maximum number of LangGraph graph steps before stopping.
    ...
    max_turns: int = Field(default=50, ge=1, description="Maximum LangGraph graph steps before stopping (config.yaml `subagents.agents.<name>.max_turns` overrides this)")
